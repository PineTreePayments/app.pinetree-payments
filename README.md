...
PineTree is a live payment platform. This section is a signpost, not a rulebook —
the rules live behind these four entry points and are deliberately not restated
here.

| Entry point | What it is |
|---|---|
| [`AGENTS.md`](AGENTS.md) | **The single coding-agent entry point**, and the engineering contract for humans too. Read it first. |
| `npm run ai:preflight` | Routes your specific task to the documents that govern it. |
| [`docs/INDEX.md`](docs/INDEX.md) | The human map of engineering documentation, with each document's authority. |
| [`docs/standards/`](docs/standards/) | The six canonical standards. [`docs/standards/README.md`](docs/standards/README.md) holds the authority order and the divergence register. |
