...
/// @title PineTreeBaseSplitV5
/// @notice Base split-payment contract for PineTree Payments.
/// @dev
...
///
/// PaymentSplit event shape is identical to PineTreeSplitV4 for full watcher compatibility.
...
contract PineTreeBaseSplitV5 {
    ...
    /// @dev Shape is identical to PineTreeSplitV4 PaymentSplit — the watcher reads
    ///      this event unchanged on both V4 and V5 contracts.
