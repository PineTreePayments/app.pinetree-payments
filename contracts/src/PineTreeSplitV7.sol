...
/// @title PineTreeSplitV7
/// @notice Base split-payment contract for PineTree Payments — V7 (active).
/// @dev
...
///
/// PaymentSplit event shape is identical to prior versions for full watcher compatibility.
...
contract PineTreeSplitV7 {
    ...
    /// @dev Shape is identical to prior PineTree split contracts — the watcher reads
