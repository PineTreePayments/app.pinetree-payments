...
describe("Dynamic embedded wallet hydration", () => {
  ...
  it("withdrawal approval uses a canonical Dynamic runtime readiness helper", () => {
    ...
    expect(helper).toContain("DYNAMIC_WALLETS_HYDRATING")
    expect(helper).toContain("DYNAMIC_WALLETS_HYDRATION_RETRY")
    expect(helper).toContain("MAX_WALLET_HYDRATION_ATTEMPTS")
