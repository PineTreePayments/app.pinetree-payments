...
describe("dashboard checkout and developer navigation", () => {
  ...
  it("uses compact Developer cards as the only section selector", () => {
    ...
    expect(wooCommerceCard).toContain('label="Ready for install testing"')
    expect(wooCommerceCard).toContain("Install the private plugin in a WooCommerce test store to validate checkout and webhooks.")
    expect(wooCommerceCard).toContain("View setup guide")
    expect(wooCommerceCard).toContain('id="woocommerce-setup-guide"')
    expect(wooCommerceCard).toContain("Open plugin folder")
