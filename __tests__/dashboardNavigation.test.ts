...
describe("dashboard checkout and developer navigation", () => {
  ...
  it("keeps Online Checkout merchant-facing", () => {
    ...
    expect(checkout).toContain('id="payment-links-management"')
    expect(checkout).toContain('id="checkout-button-setup"')
    expect(checkout).toContain("openMerchantSection(card.target)")
    expect(checkout).toContain('section?.scrollIntoView({ behavior: "smooth", block: "start" })')
    expect(checkout).toContain("Pay with Crypto Button Setup")
