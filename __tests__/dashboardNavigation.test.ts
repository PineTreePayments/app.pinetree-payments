...
describe("dashboard checkout and developer navigation", () => {
  ...
  it("uses compact Developer cards as the only section selector", () => {
    ...
    expect(wooCommerceCard).not.toContain("Download")
    expect(wooCommerceCard).toContain("onboarding contact")
    ...
    expect(developer).toContain("SDK packages are built and tested. Installation commands will be available after npm publication.")
    expect(developer).toContain("@pinetree/node")
    expect(developer).toContain("@pinetree/js")
    expect(developer).toContain("@pinetree/react")
