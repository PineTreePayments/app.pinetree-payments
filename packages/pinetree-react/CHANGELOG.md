...
All notable changes to `@pinetree/react` will be documented in this file.
...
- `usePineTree()` — hook that returns the `@pinetree/js` client instance;
...
- Depends on `@pinetree/js` (local workspace reference during private beta)
