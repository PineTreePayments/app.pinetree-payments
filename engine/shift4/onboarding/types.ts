...
export type ApplyShift4OnboardingInput = Readonly<{ merchantId: string; merchantProviderConnectionId: string; update: Shift4OnboardingUpdate; fixtureAuthorized?: boolean }>
