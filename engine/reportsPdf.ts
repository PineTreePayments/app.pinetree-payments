...
export async function generateReportPdfFromSummary(report: ReportSummary) {
  ...
  drawPremiumSummaryGrid(ctx, [
    ...
    { label: "Platform Fees",   value: currency(report.pineTreeFees),   accent: "neutral" },
    ...
    { label: "Waiting",         value: String(report.waitingCount),     accent: "neutral" },
    { label: "Processing",      value: String(report.processingCount),  accent: "blue" },
    { label: "Failed",          value: String(report.failedCount),      accent: "red" },
    { label: "Incomplete",      value: String(report.incompleteCount),  accent: "orange" },
