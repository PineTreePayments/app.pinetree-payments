...
export const PAYMENT_APP_REGISTRY: Record<string, PaymentApp> = {
  ...
  "coinbase-wallet": {
    ...
    notes:
      ...
      "Shown as 'Desktop only' for Solana (mobileInAppBrowserSolanaSupport: false). Supports Base via WalletConnect.",
  },
  ...
  // ── Extended Solana wallets (shown in "More wallets" section) ───────────────
  // These use wallet_deep_link via buildMobileWalletBrowserUrl in SolanaWalletPayment.tsx.
  // mobileInAppBrowserSolanaSupport: true — all inject a Solana provider in their in-app browser.
  ...
  ledger: {
    ...
    mobileInAppBrowserSolanaSupport: true,
    supportsLightningInvoice: false,
    notes: "Opens Ledger Live Discover browser. Requires Ledger hardware device to approve transactions.",
  },
  ...
  "brave-wallet": {
    ...
    supportsLightningInvoice: false,
    notes:
      "Brave Wallet is browser-native. The mobile deep link returns the raw target URL (no scheme wrapper). " +
      "Provider injection works when the user is already browsing in Brave.",
  },
  ...
  salmon: {
    ...
    assetSupport: ["SOL", "USDC"],
    mobileOpenStrategy: "wallet_deep_link",
    installUrl: "https://www.salmonwallet.io",
    nativeScheme: "salmon://",
    supportsPaymentRequest: true,
    supportsWalletConnect: false,
    supportsSolanaProvider: true,
  ...
  slope: {
    ...
    assetSupport: ["SOL", "USDC"],
    mobileOpenStrategy: "wallet_deep_link",
    installUrl: "https://slope.finance",
    nativeScheme: "slope://",
    supportsPaymentRequest: true,
    supportsWalletConnect: false,
    supportsSolanaProvider: true,
    mobileInAppBrowserSolanaSupport: true,
    supportsLightningInvoice: false,
    notes: "Slope wallet was compromised in August 2022. Listed for legacy compatibility only.",
  },
  ...
  sollet: {
    ...
    mobileInAppBrowserSolanaSupport: true,
    supportsLightningInvoice: false,
    notes: "Sollet is a legacy Solana web wallet. Listed for legacy compatibility only.",
  },
