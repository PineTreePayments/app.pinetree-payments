...
function setupAnswer(): Omit<PineTreeAssistantAnswer, "matchedArticles"> {
  return {
    ...
    bullets: [
      "Create a PineTree Wallet for Solana Pay, Base Pay, and Bitcoin Lightning, or configure Shift4 for card processing.",
      "For wallet rails, review the receive address PineTree should use for that network.",
