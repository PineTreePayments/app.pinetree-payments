  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="h-16 bg-blue-600 flex items-center justify-end px-8 shadow-sm relative">
          ...
          {menuOpen && (
            ...
            <div className="absolute right-8 top-14 w-52 bg-white border border-gray-200 rounded-lg shadow-lg p-3">
