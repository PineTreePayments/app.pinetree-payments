...
{mode==="login" ? "Sign in to PineTree" : "Create your PineTree account"}
...
disabled={loading}
className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2.5 rounded-md transition font-medium"
>
...
{mode==="login"
? <>New to PineTree? <button onClick={()=>setMode("signup")} className="text-blue-600 font-medium">Create account</button></>
