...
| `/api/internal/shift4/merchant` | GET | merchant session/API key | authenticated merchant | read-only | certification merchant-information service | normalized merchant capability information |
